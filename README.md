...
└── scripts/                        # Where your Python scripts (1-7) reside
...
* **Example Command**:
    ```bash
    python scripts/2_mask_blueprints.py \
        --species_name "human" \
...
* **Example Command**:
    ```bash
    python scripts/3_individual_species_gradients.py \
...
* **Example (Plotting Individual Gradients from Script 3):**
    ```bash
    python scripts/4_visualize_gradients.py \
...
* **Example Command**:
    ```bash
    python scripts/5_downsample_blueprints.py \
        --input_masked_blueprint_dir "results/2_masked_average_blueprints/" \
        --input_mask_dir "data/masks/" \
...
* **Example Command**:
    ```bash
    python scripts/6_cross_species_gradients.py \
...
* **Example Command**:
    ```bash
    python scripts/7_interactive_analyse_cross_species.py \
